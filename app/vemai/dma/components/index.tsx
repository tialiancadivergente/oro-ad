...
export default function FormDma() {
  ...
  const handleLeadCaptureSubmit = async (data: LeadCaptureSubmitData) => {
    ...
    try {
     ...
     window.location.href = `/quiz-oro/?temperature=${temperatura}&theme=2&requestId=${encodeURIComponent(
        requestId
